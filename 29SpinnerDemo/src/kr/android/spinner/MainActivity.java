...
public class MainActivity extends Activity implements AdapterView.OnItemSelectedListener {
	...
	Spinner spinner;
	TextView myTextView;
	String[] items = {"우리나라", "미국", "영국", "일본", "아프리카", "프랑스", "오스트레일리아", "칠레", "스페인", "독일", "뉴질랜드", "중국", "일본", "방콕", "홍콩", "방글라데시", "인도", "알레스카"};
	...
	//AdapterView<?>: 이벤트가 발생한 spinner객체
	//View: 이벤트가 발생한 View(데이터 매핑)
	//int: 위치값
	//long: position 값과 일치, DB사용시 변경될수 있음(primary key로)
	@Override
